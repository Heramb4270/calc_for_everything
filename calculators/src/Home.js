...
export default function Home() {
  return (
    ...
    >
      ...
      >
        <HomeGridItem
          calcName="Decimal to Binary and Binary to Decimal"
          path="/decbinandbindec"
        />
        <HomeGridItem
          calcName="Hexadecimal to Binary and Binary to Hexadecimal"
          path="/hexbinandbinhex"
        />
        <HomeGridItem
          calcName="Octal to Binary and Binary to Octal"
          path="/octbinandbinoct"
        />
        <HomeGridItem
          calcName="Decimal to Hexadecimal and Hexadecimal to Decimal"
          path="/dechexandhexdec"
        />
        <HomeGridItem
          calcName="Hexadecimal to Octal and Octal to Hexadecimal"
          path="/hexoctandocthex"
        />
        <HomeGridItem
          calcName="Decimal to Octal and Octal to Decimal"
          path="/decoctandoctdec"
        />
        <HomeGridItem
          calcName="ASCII Text to Binary and Binary to ASCII Text"
      ...
      >
        ...
        <HomeGridItem
          calcName="Quadratic Equation Solver"
        ...
        <HomeGridItem
          calcName="First Order Differential Equation Solver"
          path="/firstorderdifferentialeqsolver"
        />
        <HomeGridItem
          calcName="Work and Time Calculator"
          path="/workandtimecalculator"
        />
        <HomeGridItem
          calcName="Co-Linear Points Finder"
          path="/colinearpointsfinder"
        />
        <HomeGridItem
          calcName="Grouping Points On Same Side Of Line"
          path="/groupingpointsonsamesideofline"
        />
        <HomeGridItem
          calcName="Polynomial Equation Differential Calculator"
          path="/polynomialeqdifferentialcalc"
        />
        <HomeGridItem
          calcName="Polynomial Equation Integral Calculator"
        ...
        <HomeGridItem
          calcName="Angle Type Classifier"
          path="/angletypeclassifier"
        />
        <HomeGridItem
          calcName="Trignometric Value Calculator"
      ...
      >
        ...
        <HomeGridItem
          calcName="Chemical Equation Balancer"
          path="/chemicaleqbalancer"
        />
        <HomeGridItem
          calcName="Chemical Kinetics Calculator"
      ...
      >
        <HomeGridItem
          calcName="FD Maturity Calculator"
          path="/fdmaturitycalc"
        />
        <HomeGridItem
          calcName="RD Maturity Calculator"
          path="/rdmaturitycalc"
        />
        <HomeGridItem
          calcName="Loan Repayment Calculator"
        ...
        <HomeGridItem
          calcName="Profit Margin Calculator"
          path="/profitmargincalc"
        />
      </Grid>
      <br />
      <Typography pt={1} variant="h5">
      ...
      >
        ...
        <HomeGridItem
          calcName="Pregnancy Due Date Calculator"
